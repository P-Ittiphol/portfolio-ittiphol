...
const Contact = () => {
    ...
    const onSubmitForm = async (event) => {
        ...
        formData.append("access_key", "d046ad1f-5810-447b-b433-f801dc97fe45");
  ...
  return (
    ...
    dark:bg-none'>
        ...
        onSubmit={onSubmitForm} className='max-w-2xl mx-auto'>
            <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
                ...
                border-gray-400 rounded-md bg-white dark:bg-black/30 dark:border-white/90' name='name'/>
                ...
                border-gray-400 rounded-md bg-white dark:bg-black/30 dark:border-white/90' name='email'/>
            </div>
            ...
            border-gray-400 rounded-md bg-white mb-6 dark:bg-black/30 dark:border-white/90' name='message'></motion.textarea>

            <motion.button 
            whileHover={{ scale: 1.05 }}
            transition={{ duration: 0.3 }}
            type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 
            text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-black'>
                <LinkHover text="Submit&nbsp;now"/>
